...
export default class PersonasDBHelper {
  ...
  upload =[
    ...
    ['sofia.ab', 'password1!', 'Sofia', 'Abrahams', 'Sofia.Abrahams@email.com', '(844) 718-6610', 'Wal-Mart Stores ', '250 Cinder  Berry  Corner 19614', 'Kabul ', 'AF', 'http://http://www.starc.com.cn', '1'],
    ['tania.sm', 'password1!', 'Tania', 'Smail', 'Tania.Smail@email.com', '(844) 132-0958', 'Exxon Mobil ', '21 Cinder  Brook  Cove 13820', 'Luanda ', 'AO', 'http://http://www.starc.com.cn', '2'],
    ['nannie.gl', 'password1!', 'Nannie', 'Glennon', 'Nannie.Glennon@email.com', '(844) 335-2563', 'Chevron ', '111 Clear  Barn  Arbor 11770', 'Buenos Aires ', 'AR', 'http://http://www.starc.com.cnk', '3']
  ];

  uploadSingleMultiIdents = ['sofia.ab', 'password1!', 'Sofia', 'Abrahams', 'Sofia.Abrahams@email.com', '(844) 718-6610', 'Wal-Mart Stores ', '250 Cinder  Berry  Corner 19614', 'Kabul ', 'AF', 'http://http://www.starc.com.cn', '1'];
  ...
  personaIdentifiers = [{ key: 'statement.actor.mbox', value: 'mailto:sofia.abrahams@email.com' }, { key: 'statement.actor.account', value: { name: 'sofia.ab', homePage: 'http://www.starc.com.cn' } }, { key: 'statement.actor.openid', value: '1' }]
