        ...
        <AuthContainer>
            ...
            <CardText>
...

              {
                models.isEmpty() && orgSearch === '' ? (
                  ...
                  <div>
                    <div>
                      <h4>{textCN.getSiteTextById('indexYourOrganisations')}</h4>
                      {
          ...
          <div className={styles.loginButtons}>
            ...
            <button className="btn btn-danger" onClick={this.onClickLogout}>
              <i className="ion ion-log-out" /> {textCN.getSiteTextById('homeLogOut')}
            </button>
