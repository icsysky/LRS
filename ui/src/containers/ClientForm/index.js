    ...
    <div className="row">
      <div className="col-md-12" >
        <div className="form-group">
          <label htmlFor="lrsTitleInput"> {textCN.getSiteTextById('setClientTitle')}</label>
          <input
        ...
        <div className="form-group">
          <Checkbox
            label= {textCN.getSiteTextById('setClientEnabled')}
        ...
        <div className="form-group">
          <label htmlFor="overallScopesCheckboxGroup"> {textCN.getSiteTextById('setClientOverallScopes')} </label>
        ...
        {lrsId &&
          <div>
            <div className="form-group">
              <label htmlFor="xapiScopesCheckboxGroup"> {textCN.getSiteTextById('setClientScopes')}  </label>
