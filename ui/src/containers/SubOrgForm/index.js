...
class SubOrgForm extends Component {
  ...
  renderButtonContent = () => {
    ...
    switch (exportProgress) {
      ...
      default: {
        return <span>{textCN.getSiteTextById('saOrgUpload')}</span>;
      }
    }
  };
    ...
    return (
      <div>
        <div
          ...
          <label htmlFor={attemptsId}>{textCN.getSiteTextById('saOrgAllowedAttempts')}</label>
          <input
            id={attemptsId}
            className="form-control"
        ...
        <div
          ...
          <label htmlFor={lockoutId}>{textCN.getSiteTextById('saOrgLockoutTime')}</label>
          <input
            id={lockoutId}
            className="form-control"
    ...
    return (
      <div>
        <div
          ...
          {textCN.getSiteTextById('saOrgHistoryPasswordNumbers')}
          </label>
          <input
            id={passwordTotalId}
            className="form-control"
      ...
      <form onSubmit={this.handleSubmit} encType="multipart/form-data">
        <label
          ...
          <input
            ...
            style={{ display: 'none' }} />
          {textCN.getSiteTextById('saOrgChooseLogo')}
        </label>
  ...
  renderMinPasswordSetting = (errorMessages, settings) => {
    ...
    return (
      <div
        ...
        <label htmlFor={minPasswordId}>{textCN.getSiteTextById('saOrgMinPswLen')}</label>
        <input
          id={minPasswordId}
          className="form-control"
    ...
    return (
      <div className="row">
        <div className="col-md-12">
          ...
          <fieldset>
            <legend className="pageHeader">{textCN.getSiteTextById('saOrgAuthSettings')}</legend>
            ...
            {!settings.get('PASSWORD_USE_CUSTOM_REGEX') &&
              <div>
                <div className="form-group">
                  <Checkbox
                    label={textCN.getSiteTextById('saOrgNeedOneLetter')}
                ...
                <div className="form-group">
                  <Checkbox
                    label={textCN.getSiteTextById('saOrgNeedOneNumber')}
                    style={styles.checkbox}
                    onChange={this.onChangeBooleanSetting.bind(
                      null,
            ...
            <div className="form-group">
              <Checkbox
                label={textCN.getSiteTextById('saOrgCustomRequirements')}
                style={styles.checkbox}
                onChange={this.onChangeBooleanSetting.bind(
                  null,
            ...
            <div className="form-group">
              <Checkbox
                label={textCN.getSiteTextById('saOrgLockAllowedAttempts')}
                style={styles.checkbox}
                onChange={this.onChangeBooleanSetting.bind(
                  null,
                  'LOCKOUT_ENABLED'
            ...
            <div className="form-group">
              <Checkbox
                label={textCN.getSiteTextById('saOrgCheckPassword')}
                style={styles.checkbox}
                onChange={this.onChangeBooleanSetting.bind(
                  null,
