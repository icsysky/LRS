...
class SeriesEditor extends Component {
  ...
  renderStackToggle = () => (
    <div className="form-group">
      <label htmlFor="toggleInput">{textCN.getSiteTextById('orgVisualiseStacked_Grouped')}</label>
      <div id="toggleInput">
        <Switch
  ...
  renderSeriesAdder = () => (
    <div className="form-group">
      <button
        ...
        <i className="ion ion-plus" /> {textCN.getSiteTextById('orgVisualiseAddQuery')}
      </button>
    </div>
  )
