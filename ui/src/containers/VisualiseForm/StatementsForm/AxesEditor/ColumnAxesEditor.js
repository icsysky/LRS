  ...
  render = () => (
    <div>
      <div className="form-group">
        <label htmlFor="toggleInput" className="clearfix">{textCN.getSiteTextById('orgVisualiseX_Axis')}</label>
        <div className="form-group">
          <DebounceInput
            id={'xAxisLabel'}
      ...
      <div className="form-group">
        <label htmlFor="toggleInput" className="clearfix">{textCN.getSiteTextById('orgVisualiseY_Axis')}</label>
        <div className="form-group">
          <DebounceInput
            id={'yAxisLabel'}
            className="form-control"
