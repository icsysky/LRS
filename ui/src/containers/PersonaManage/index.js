          ...
          <div className="heading heading-light">
            <span className="pull-right open_panel_btn">
              <button
                ...
                <i className="ion ion-upload" /> {textCN.getSiteTextById('orgPeorleImportPeople')}
              </button>
            </span>
            <span className="pull-right open_panel_btn">
              <button
                ...
                <i className="ion ion-plus" /> {textCN.getSiteTextById('orgPeorleAddPerson')}
              </button>
            </span>
            <span
            ...
            {textCN.getSiteTextById('orgPeorleManage')}
          </div>
        </header>
        <div className="row">
