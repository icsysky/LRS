  ...
  return (
    <div>
      <div className="form-group">
        <label htmlFor={`${model.get('_id')}nameInput`}>{textCN.getSiteTextById('setRolesTitle')}</label>
        <input
      ...
      <div className="form-group">
        <label htmlFor={`${model.get('_id')}descriptionInput`}> {textCN.getSiteTextById('setRolesDescription')}</label>
        <input
      ...
      <div className="form-group">
        <label htmlFor={`${model.get('_id')}scopes`}> {textCN.getSiteTextById('setRolesOrganisationScopes')}  </label>
