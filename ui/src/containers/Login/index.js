    ...
    return (
      <FullPageBackground width={400}>
        <div className={styles.loginWrapper}>
          <Helmet title="- Login" />
          <h3>{textCN.getSiteTextById('homeWelcome')}</h3>
          <form>
            <Card>
              <CardText>
            ...
            <div className={styles.buttons}>
              <div className={styles.loginButtons}>
                <button type="submit" className="btn btn-primary" onClick={this.onClickLogin} >
                  <i className="ion-log-in" /> {textCN.getSiteTextById('homeLogin')}
                </button>
                {googleAuthEnabled &&
                  <button
              ...
              <div className={styles.otherButtons}>
                <Link className="btn btn-primary" routeName={'forgot'}>
                  <i className="ion-key" /> {textCN.getSiteTextById('homeResetPassword')}
                </Link>
              </div>
            </div>
            }
