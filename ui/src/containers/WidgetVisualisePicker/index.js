...
class WidgetVisualisePicker extends Component {
  ...
  renderTitle = () => {
    ...
    return (
      <div className="form-group" style={{ width: '100%' }}>
        <label htmlFor={htmlFor} className="clearfix">{textCN.getSiteTextById('orgChartWidgetTitle')}</label>
        <input
          id={htmlFor}
  ...
  renderVisualisations = () => {
    ...
    return (
      <div className="form-group" style={{ width: '100%' }}>
        <label htmlFor={htmlFor} className="clearfix">{textCN.getSiteTextById('orgChartVisualisation')}</label>
        <div id={htmlFor}>
          <ModelAutoComplete
            schema={schema}
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-header modal-header-bg">
                  ...
                  <h4 className="modal-title">{textCN.getSiteTextById('orgChartChoosevisualisation')}</h4>
                </div>
